...
INSERT INTO lit_dictionary (parent_id, dict_key, dict_value, order_num, remark, is_system) VALUES (0, 'menu_type', '菜单类型', 1, '', true);
INSERT INTO lit_dictionary (parent_id, dict_key, dict_value, order_num, remark, is_system) VALUES (last_insert_id(), 'menu_type_top', '顶部导航菜单', 1, '', true);
INSERT INTO lit_dictionary (parent_id, dict_key, dict_value, order_num, remark, is_system) VALUES (last_insert_id()-1 , 'menu_type_left', '左侧菜单', 2, '', false);

INSERT INTO lit_dictionary (dict_key, dict_value, order_num, dict_level, remark, is_system, parent_id) VALUES ('authority_type', '权限类型', 4, 1, '权限类型', 1, null);
INSERT INTO lit_dictionary (dict_key, dict_value, order_num, dict_level, remark, is_system, parent_id) VALUES ('system_authority', '系统权限', 1, 2, '系统权限', 1, last_insert_id());
INSERT INTO lit_dictionary (dict_key, dict_value, order_num, dict_level, remark, is_system, parent_id) VALUES ('other_authority', '其他权限', 2, 2, '其他权限', 0, last_insert_id()-1);
INSERT INTO lit_dictionary (dict_key, dict_value, order_num, dict_level, remark, is_system, parent_id) VALUES ('user_type', '用户类型', 3, 1, '用户类型', 0, NULL);



INSERT INTO lit_menu (menu_code, menu_name, menu_icon, menu_url, order_num, remark, menu_type, module, is_enable, parent_id) VALUES ('system', '系统管理', '１', null, 1, '系统管理', 'menu_type_left', null, 1, null);
INSERT INTO lit_menu (menu_code, menu_name, menu_icon, menu_url, order_num, remark, menu_type, module, is_enable, parent_id) VALUES ('system_menu', '菜单管理', '12', '/plugin/menu', 1, '菜单管理', 'menu_type_left', null, 1, last_insert_id());
INSERT INTO lit_menu (menu_code, menu_name, menu_icon, menu_url, order_num, remark, menu_type, module, is_enable, parent_id) VALUES ('system_dictionary', '字典管理', '123', '/plugin/dictionary', 2, '字典管理', 'menu_type_left', null, 1, 1);
INSERT INTO lit_menu (menu_code, menu_name, menu_icon, menu_url, order_num, remark, menu_type, module, is_enable, parent_id) VALUES ('system_param', '参数管理', '12', '/plugin/param', 3, '参数管理', 'menu_type_left', null, 1, 1);
INSERT INTO lit_menu (menu_code, menu_name, menu_icon, menu_url, order_num, remark, menu_type, module, is_enable, parent_id) VALUES ('system_organization', '机构管理', '2', '/plugin/org', 5, '机构管理', 'menu_type_left', null, 1, 1);
INSERT INTO lit_menu (menu_code, menu_name, menu_icon, menu_url, order_num, remark, menu_type, module, is_enable, parent_id) VALUES ('system_user', '用户管理', '2', '/plugin/user', 4, '用户管理', 'menu_type_left', null, 1, 1);
INSERT INTO lit_menu (menu_code, menu_name, menu_icon, menu_url, order_num, remark, menu_type, module, is_enable, parent_id) VALUES ('system_role', '角色管理', '12', '/plugin/role/list', 6, '角色管理', 'menu_type_left', null, 1, 1);
INSERT INTO lit_menu (menu_code, menu_name, menu_icon, menu_url, order_num, remark, menu_type, module, is_enable, parent_id) VALUES ('system_authority', '权限管理', '1', '/plugin/authority/list', 7, '权限管理', 'menu_type_left', null, 1, 1);

INSERT INTO lit_authority (authority_id, authority_code, authority_name, authority_type, remark, sys_time) VALUES (1, 'menu_manager', '菜单管理', 'system_authority', '菜单管理', '2018-02-01 11:19:00');
INSERT INTO lit_authority (authority_id, authority_code, authority_name, authority_type, remark, sys_time) VALUES (2, 'dictionary_manager', '字典管理', 'system_authority', '字典管理', '2018-02-01 11:19:00');
INSERT INTO lit_authority (authority_id, authority_code, authority_name, authority_type, remark, sys_time) VALUES (3, 'param_manager', '参数管理', 'system_authority', '参数管理', '2018-02-01 11:19:00');
INSERT INTO lit_authority (authority_id, authority_code, authority_name, authority_type, remark, sys_time) VALUES (4, 'user_manager', '用户管理', 'system_authority', '用户管理', '2018-02-01 11:19:00');
INSERT INTO lit_authority (authority_id, authority_code, authority_name, authority_type, remark, sys_time) VALUES (5, 'organization_manager', '机构管理', 'system_authority', '机构管理', '2018-02-01 11:19:00');
INSERT INTO lit_authority (authority_id, authority_code, authority_name, authority_type, remark, sys_time) VALUES (6, 'role_manager', '角色管理', 'system_authority', '角色管理', '2018-02-01 11:19:00');
INSERT INTO lit_authority (authority_id, authority_code, authority_name, authority_type, remark, sys_time) VALUES (7, 'authority_manager', '权限管理', 'system_authority', '权限管理', '2018-02-01 11:19:00');

INSERT INTO lit_role (role_id, role_code, role_name, remark, sys_time) VALUES (1, 'role_system', '系统管理员', '系统管理员', '2018-01-16 15:26:36');
INSERT INTO lit_role (role_id, role_code, role_name, remark, sys_time) VALUES (2, 'role_user', '普通用户', '普通用户', '2018-01-16 20:13:41');
