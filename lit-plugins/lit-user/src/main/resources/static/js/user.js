$(function () {
    ...
    var urlPrefix = path + "/plugin/user";
    ...
    $('#data-add').on('click', function (e) {
        openEdit('增加用户', compiledEditTpl.render(), '#form-edit', urlPrefix + '/add.json')
    });
    ...
    $('#data-update').on('click', function (e) {
        ...
        $.post(urlPrefix + '/get.json', {
            ...
            openEdit('修改用户', compiledEditTpl.render(result.result), '#form-edit', urlPrefix + '/update.json');
        });
