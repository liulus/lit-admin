...
INSERT INTO lit_menu (menu_code, menu_name, menu_icon, menu_url, order_num, memo, menu_type, module, is_enable, parent_id) VALUES ('system_dictionary', '字典管理', '123', '/plugin/dictionary', 2, '字典管理', 'menu_type_left', null, 1, SELECT menu_id from menu where menu_code='system');
INSERT INTO lit_menu (menu_code, menu_name, menu_icon, menu_url, order_num, memo, menu_type, module, is_enable, parent_id) VALUES ('system_param', '参数管理', '12', '/plugin/param', 3, '参数管理', 'menu_type_left', null, 1, SELECT menu_id from menu where menu_code='system');
INSERT INTO lit_menu (menu_code, menu_name, menu_icon, menu_url, order_num, memo, menu_type, module, is_enable, parent_id) VALUES ('system_organization', '机构管理', '2', '/plugin/org', 5, '机构管理', 'menu_type_left', null, 1, SELECT menu_id from menu where menu_code='system');
INSERT INTO lit_menu (menu_code, menu_name, menu_icon, menu_url, order_num, memo, menu_type, module, is_enable, parent_id) VALUES ('system_user', '用户管理', '2', '/plugin/user', 4, '用户管理', 'menu_type_left', null, 1, SELECT menu_id from menu where menu_code='system');
