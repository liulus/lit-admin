...
(
  ...
  authority_code  VARCHAR(32) NOT NULL COMMENT '权限码',
  authority_name  VARCHAR(128) NOT NULL COMMENT '权限码名称',
...
CREATE TABLE lit_role_authority(
  ...
  authority_code VARCHAR(32) COMMENT '权限码'
...
CREATE TABLE lit_user_role(
  ...
  role_id INT UNSIGNED NOT NULL COMMENT '角色Id',
  role_code VARCHAR(32) COMMENT '角色名'
